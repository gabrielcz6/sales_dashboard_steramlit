...
import pandas as pd
#visualizar la pagina en modo ancho por default al iniciar
...
df_ventas=pd.read_csv("https://raw.githubusercontent.com/gabrielcz6/sales_dashboard_streamlit/main/base_ventas.csv")
